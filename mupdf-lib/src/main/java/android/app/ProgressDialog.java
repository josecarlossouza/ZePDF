...
public class ProgressDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray a = mContext.obtainStyledAttributes(null,
                ...
                new int[]{getSysRes("AlertDialog", "styleable")},
                // R.attr.alertDialogStyle, 0);
                getSysRes("alertDialogStyle", "attr"), 0);
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            View view = inflater.inflate(a.getResourceId(
                    ...
                    getSysRes("AlertDialog_horizontalProgressLayout", "styleable"),
                    // R.layout.alert_dialog_progress), null);
                    getSysRes("alert_dialog_progress", "layout")), null);
            // mProgress = (ProgressBar) view.findViewById(R.id.progress);
            mProgress = (ProgressBar) view.findViewById(getSysRes("progress", "id"));
            // mProgressNumber = (TextView) view.findViewById(R.id.progress_number);
            mProgressNumber = (TextView) view.findViewById(getSysRes("progress_number", "id"));
            // mProgressPercent = (TextView) view.findViewById(R.id.progress_percent);
            mProgressPercent = (TextView) view.findViewById(getSysRes("progress_percent", "id"));
            setView(view);
        } else {
            View view = inflater.inflate(a.getResourceId(
                    // R.styleable.AlertDialog_progressLayout,
                    getSysRes("AlertDialog_progressLayout", "styleable"),
                    // R.layout.progress_dialog), null);
                    getSysRes("layout", "progress_dialog")), null);
            // mProgress = (ProgressBar) view.findViewById(R.id.progress);
            mProgress = (ProgressBar) view.findViewById(getSysRes("progress", "id"));
            // mMessageView = (TextView) view.findViewById(R.id.message);
            mMessageView = (TextView) view.findViewById(getSysRes("message", "id"));
            setView(view);
        }
        a.recycle();
        if (mMax > 0) {
    ...
    private int getSysRes(String name, String deftype) {
